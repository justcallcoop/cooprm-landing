...
export default function App() {
  return (
    <div style={{ minHeight: '100vh', background: '#ffffff', color: dark }}>
      ...
      {/* Product Showcase */}
      <section style={{ background: '#0d0d0f', padding: '100px 40px' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <Reveal>
            <div style={{ textAlign: 'center', marginBottom: '72px' }}>
              <p style={{ fontSize: '11px', fontWeight: '700', color: '#C8102E', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: '16px' }}>See it in action</p>
              <h2 style={{ fontSize: '48px', fontWeight: '900', letterSpacing: '-0.04em', color: '#ffffff', lineHeight: 1.08 }}>
                Everything you need,<br />
                <span style={{ color: 'rgba(255,255,255,0.35)', fontWeight: '400' }}>right where you need it.</span>
              </h2>
            </div>
          </Reveal>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '64px' }}>
            {[
              ...
              <Reveal key={i} delay={i * 100}>
                <div style={{ display: 'flex', flexDirection: i % 2 === 0 ? 'row' : 'row-reverse', gap: '56px', alignItems: 'center', flexWrap: 'wrap' }}>
                  {/* Screenshot */}
                  <div style={{
                    flex: '1 1 580px',
                  ...
                  <div style={{ flex: '1 1 180px', minWidth: '160px' }}>
                    <p style={{ fontSize: '11px', fontWeight: '700', color: '#C8102E', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: '12px' }}>{item.label}</p>
                    <p style={{ fontSize: '26px', fontWeight: '900', color: '#C8102E', letterSpacing: '-0.03em', lineHeight: 1.2, marginBottom: '16px' }}>{item.label}</p>
                    <p style={{ fontSize: '15px', color: '#C8102E', lineHeight: 1.8, opacity: 0.75 }}>{item.desc}</p>
                  </div>
                </div>
              </Reveal>
            ))}
